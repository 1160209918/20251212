...
type IndicatorConfig struct {
	...
	EnableSuperTrend  bool `json:"enable_supertrend"`   // SuperTrend indicator
	EnableFRVP        bool `json:"enable_frvp"`         // Fixed Range Volume Profile
	EnableMACDHist    bool `json:"enable_macd_hist"`    // MACD Histogram
	...
	SuperTrendPeriod     int     `json:"supertrend_period,omitempty"`     // default 10
	SuperTrendMultiplier float64 `json:"supertrend_multiplier,omitempty"` // default 3.0
	// FRVP configuration
	FRVPLookback int `json:"frvp_lookback,omitempty"` // default 338
...
type RiskControlConfig struct {
	...
	// minimum stop loss distance (default 0.003 = 0.3%)
	MinStopLossPct *float64 `json:"min_stop_loss_pct,omitempty"`
	// maximum stop loss distance (default 0.05 = 5%)
	MaxStopLossPct *float64 `json:"max_stop_loss_pct,omitempty"`

	// Circuit breaker parameters
	// maximum new positions per day (default 8)
	MaxDailyTrades *int `json:"max_daily_trades,omitempty"`
	// total loss threshold for circuit breaker (default 0.15 = 15%)
	TotalLossCircuitBreaker *float64 `json:"total_loss_circuit_breaker,omitempty"`

	// Add position parameters
	// profit interval for adding positions (default 0.5 = 50%)
	AddPositionProfitInterval *float64 `json:"add_position_profit_interval,omitempty"`
	// single add position ratio vs initial position (default 0.1 = 10%)
	AddPositionRatio *float64 `json:"add_position_ratio,omitempty"`
	// cumulative add position limit (default 2.0 = 200%)
	AddPositionCumulativeLimit *float64 `json:"add_position_cumulative_limit,omitempty"`
	// safety margin: minimum distance from stop loss after adding (default 0.005 = 0.5%)
	AddPositionSafetyMargin *float64 `json:"add_position_safety_margin,omitempty"`

	// Reduce position parameters
	// single reduce position ratio vs current position (default 0.3 = 30%)
	ReducePositionRatio *float64 `json:"reduce_position_ratio,omitempty"`
}
