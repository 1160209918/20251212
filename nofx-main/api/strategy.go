...
func (s *Server) handleStrategyTestRun(c *gin.Context) {
	...
	indicatorParams := &market.IndicatorParams{
		SupertrendPeriod:     req.Config.Indicators.SuperTrendPeriod,
		SupertrendMultiplier: req.Config.Indicators.SuperTrendMultiplier,
		FRVPLookback:         req.Config.Indicators.FRVPLookback,
	}
