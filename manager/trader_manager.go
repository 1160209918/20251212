...
func (tm *TraderManager) addTraderFromStore(traderCfg *store.Trader, aiModelCfg *store.AIModel, exchangeCfg *store.Exchange, st *store.Store) error {
	...
	traderConfig := trader.AutoTraderConfig{
		...
		// Pass anti-martingale parameters from trader config
		BaseCapitalRatio:               traderCfg.BaseCapitalRatio,
		AntiMartingaleProfitConversion: traderCfg.AntiMartingaleProfitConversion,
		AntiMartingaleUsageRatio:       traderCfg.AntiMartingaleUsageRatio,
		AntiMartingalePoolLimit:        traderCfg.AntiMartingalePoolLimit,
	}
